...
export default function Register() {
  ...
  const submit = async (e) => {
    ...
    // name: displayName, // existing pages use profile.name
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                {fpStatus === 'capturing' && (
                  <button
                    type="button"
                    disabled
                    className="rounded-xl bg-emerald-600/70 text-white font-semibold px-4 py-2"
                  >
                    Capturing…
                  </button>
                )}
